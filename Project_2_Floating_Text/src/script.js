...
fontloader.load(
    ...
    (font)=>{
        ...
        for(let i = 0; i < 500; i++){
            ...
            boxes.position.x = (Math.random() - 0.5) * 140
            boxes.position.y = (Math.random() - 0.5) * 140
            boxes.position.z = (Math.random() - 0.5) * 140
        ...
        for(let i = 0; i < 350; i++){
            ...
            unknown.position.x = (Math.random() - 0.5) * 200
            unknown.position.y = (Math.random() - 0.5) * 200
            unknown.position.z = (Math.random() - 0.5) * 200
